        ...
        return AppointmentResponse.builder()
                ...
                .service(appointment.getService() != null ?
                        AppointmentResponse.ServiceInfo.builder()
                                ...
                                .build() : null)
                .slot(appointment.getWorkSlot() != null ?
                        AppointmentResponse.SlotInfo.builder()
                                .id(appointment.getWorkSlot().getId())
                                .date(appointment.getWorkSlot().getDate())
                                .startTime(appointment.getWorkSlot().getStartTime())
                                .endTime(appointment.getWorkSlot().getEndTime())
                                .build() : null)
